...
csv_file= open('PROJET_CLOUD/ajout_IAS_scrape.csv', 'w', encoding='utf-8')
...
upload_file_s3("PROJET_CLOUD/ajout_IAS_scrape.csv","m2dsia-pomane-mamadou","ajout_IAS_scrape.csv")
# In[ ]:
